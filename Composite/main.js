...
var Directory_1 = require("./components/Directory");
// Create files -> files are the leaf nodes - meaning they wont have child nodes.
var file1 = new File_1.File("resume.pdf", 120);
var file2 = new File_1.File("photo.jpg", 300);
var file3 = new File_1.File("song.mp3", 5000);
var file4 = new File_1.File("notes.txt", 10);
// Create directories -> these rae the composite nodes which can have child nodes, 
// either file or sub directries
var documents = new Directory_1.Directory("Documents");
documents.add(file1);
documents.add(file4); // adding leaf nodes -> files
var pictures = new Directory_1.Directory("Pictures");
pictures.add(file2); // adding leaf nodes -> files
var music = new Directory_1.Directory("Music");
music.add(file3); // adding leaf nodes -> files
// Create root directory
var home = new Directory_1.Directory("Home"); // this is the root directory 
home.add(documents);
home.add(pictures);
